            ...
            <form onSubmit={handleProfileSubmit} className="p-8">
              ...
              <div className="w-24 h-24 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-full flex items-center justify-center">
                ...
                <div>
                  ...
                  <button
                    type="button"
                    className="mt-3 px-4 py-2 bg-emerald-600 text-white rounded-lg hover:shadow-lg hover:shadow-emerald-600/30 text-sm font-medium transition-shadow"
                  >
                    Change Photo
                  </button>
                </div>
              ...
              <div className="flex justify-end mt-8 pt-6 border-t border-gray-200">
                <button
                  type="submit"
                  className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-lg hover:shadow-lg hover:shadow-emerald-600/30 font-medium transition-shadow"
                >
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="flex justify-between text-xs text-gray-500 mt-2">
                    ...
                    <span className="font-bold text-emerald-600">Level {preferences.cleanliness}</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <label className="flex items-center gap-3 cursor-pointer p-4 border-2 border-gray-200 rounded-lg hover:border-emerald-300 transition-colors">
                    <input
                      type="checkbox"
